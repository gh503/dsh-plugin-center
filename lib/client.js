...
window.__ModuleLoader__.load({
  ...
  const TAG = "dpm-css";
  const PANEL_CSS = `
  .dpm-fab{position:fixed;right:20px;bottom:72px;z-index:9998;width:44px;height:44px;border-radius:50%;border:none;cursor:pointer;font-size:20px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#3b9eff,#8f7bff);color:#fff;box-shadow:0 6px 18px rgba(60,110,255,.35);}
  .dpm-panel{position:fixed;right:20px;bottom:124px;z-index:9999;width:320px;max-height:74vh;overflow:auto;box-sizing:border-box;padding:14px;border-radius:16px;border:1px solid rgba(23,30,60,.12);background:rgba(255,255,255,.94);color:#1a1d24;display:none;flex-direction:column;gap:10px;box-shadow:0 12px 36px rgba(30,40,80,.2);backdrop-filter:blur(14px);font-size:13px;line-height:1.5;}
